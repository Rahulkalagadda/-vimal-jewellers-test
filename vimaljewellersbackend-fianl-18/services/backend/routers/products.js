...
router.get("/slug/:slug", async (req, res) => {
  try {
    ...
    // Log the variants to debug
    console.log(`[DEBUG] Fetching product ${req.params.slug}`);
    console.log(`[DEBUG] availableMetals:`, productData.availableMetals);
    console.log(`[DEBUG] availableDiamonds:`, productData.availableDiamonds);
